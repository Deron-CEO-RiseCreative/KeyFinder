...
#import "LockLibraryViewController.h"
#import "AppDelegate.h"
@import AssetsLibrary;

@interface LockLibraryViewController ()

@end

@implementation LockLibraryViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    _btnShowAll.layer.cornerRadius = 6;
...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    CGRect frame = _tblKey.frame;
    //    cell.imageView.frame = CGRectMake(0,0,frame.size.width,200);
    
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0,0,frame.size.width,220)];
    
    ALAssetsLibrary *assetLib = [[ALAssetsLibrary alloc] init];
    [assetLib assetForURL:keylock.key_imageUrl
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self performSegueWithIdentifier:@"segueLibraryToKey"
                              sender:Nil];
}
